...
class BRDefaultColor {
    //        progressView.setCircleStrokeColor(UIColor.white, circleFillColor: UIColor.white, progressCircleStrokeColor: UIColor(red: 50.0/255.0, green: 190.0/255.0, blue: 63.0/255.0, alpha: 1.0), progressCircleFillColor: UIColor.white)
    
    //circleStrokeColor = UIColor(red: 233.0/255.0, green: 233.0/255.0, blue: 233.0/255.0, alpha: 1)
    // progressCircleStrokeColor = UIColor(red: 0.0/255.0, green: 184.0/255.0, blue: 249.0/255.0, alpha: 1)
    //progressCircleFillColor = UIColor(red: 0.0/255.0, green: 184.0/255.0, blue: 249.0/255.0, alpha: 0.2)
    
    static let circleStrokeColor: UIColor = UIColor.white
    static let circleFillColor: UIColor = UIColor.white
    static let progressCircleStrokeColor: UIColor = UIColor(red: 50.0/255.0, green: 190.0/255.0, blue: 63.0/255.0, alpha: 1.0)
    static let progressCircleFillColor: UIColor = UIColor.white
}
...
class BRCircularProgressView: UIView {
    ...
    private var textFont: UIFont? = UIFont.boldSystemFont(ofSize: 15)
    ...
    func setProgressTextFont(_ font: UIFont = UIFont.boldSystemFont(ofSize: 15), color: UIColor = UIColor.black) {
        textLabel.font = font
...
//        let startAngle: CGFloat = -.pi/2 + .pi * 2 * progress
