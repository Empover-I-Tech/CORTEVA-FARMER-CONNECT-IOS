//
//  CEPProfileUpdateViewController.swift
//  FarmerConnect
//
...
class CEPProfileUpdateViewController: BaseViewController,UITextFieldDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var txt_MDOno: UITextField!
    @IBOutlet weak var txt_retailerMobileNo: UITextField!
    
    @IBOutlet weak var lbl_enterRetailerMno: UILabel! //
    @IBOutlet weak var lbl_mdoMno: UILabel!
    
    
    @IBOutlet weak var overallPaddyYes_btn: UIButton!
    @IBOutlet weak var overallPaddyNo_btn: UIButton!
    @IBOutlet weak var PexalonUsedYes_btn: UIButton!
    @IBOutlet weak var PexalonUsedNos_btn: UIButton!
    ...
    @IBOutlet weak var totalCropacresNamelbl: UILabel!
    
    @IBOutlet weak var lblCoudy: UILabel!
    
    @IBOutlet weak var cropsLBLtitle: UILabel!
    @IBOutlet weak var lblAcresPaddy: UILabel!
    
    @IBOutlet weak var lblPaddyused: UILabel!
    @IBOutlet weak var lblOverallPaddy: UILabel!
    var yieldOfPaddy = "No"
    ...
    func imagePickerControllerDidCancel(_ picker: UIImagePickerController) {
        let userObj = Constatnts.getUserObject()
        let firebaseParams = [MOBILE_NUMBER:userObj.mobileNumber!,USER_ID:userObj.customerId!,Screen_Name_Param: "CEPProfileUpdateViewController"]
        // self.registerFirebaseEvents(CEP_Capture_Photo_Cancel, "", "", "", parameters: firebaseParams as NSDictionary)
        self.dismiss(animated: true, completion: nil)
    }
    
    //MARK:- PEXALON yes/no action
    
    @IBAction func overallYieldPAddyAction(_ sender: UIButton) {
        //yess 100
        //no 200
        
        if sender.tag == 100 {
            yieldOfPaddy = "Yes"
            overallPaddyYes_btn.setImage(UIImage(named: "SelectRadioBlue"), for: .normal)
            overallPaddyNo_btn.setImage(UIImage(named: "Radio"), for: .normal)
            //radioEmpty
        }
        else  if sender.tag == 200 {
            yieldOfPaddy = "No"
            overallPaddyYes_btn.setImage(UIImage(named: "Radio"), for: .normal)
            overallPaddyNo_btn.setImage(UIImage(named: "SelectRadioBlue"), for: .normal)
            //radioEmpty
        }
    }
    ...
    @IBAction func pexalonKharifAction(_ sender: UIButton) {
        if sender.tag == 300 {
            isPExalonKharifused = "Yes"
            PexalonUsedYes_btn.setImage(UIImage(named: "SelectRadioBlue"), for: .normal)
            PexalonUsedNos_btn.setImage(UIImage(named: "Radio"), for: .normal)
            //radioEmpty
        }
        else  if sender.tag == 400 {
            isPExalonKharifused = "No"
            PexalonUsedYes_btn.setImage(UIImage(named: "Radio"), for: .normal)
            PexalonUsedNos_btn.setImage(UIImage(named: "SelectRadioBlue"), for: .normal)
            //radioEmpty
        }
    }
    ...
    override func viewDidLoad() {
        ...
        self.setLeftPaddingToTextField(txtTotalCropAcres, 10)
        ...
        self.setLeftPaddingToTextField(txt_retailerMobileNo, 10)
        self.setLeftPaddingToTextField(txt_MDOno, 10)
       // submitBtn.backgroundColor = App_Theme_Blue_Color//UIColor(red: 104.0/255.0, green: 104.0/255.0, blue: 104.0/255.0, alpha: 1)
        ...
        lbl_enterRetailerMno.text = NSLocalizedString("cep_enter_retailer_mno", comment: "")//
       lbl_mdoMno.text = NSLocalizedString("cep_enter_Mdo_mno", comment: "")
        ...
        lblAcresPaddy.text = NSLocalizedString("cep_How_many_rice_Acres", comment: "")  //
        lblOverallPaddy.text = NSLocalizedString("cep_want_to_increase_yield", comment: "")  //
        lblOverallPaddy.text = NSLocalizedString("cep_want_to_increase_yield", comment: "")  //
        overallPaddyYes_btn.setTitle(NSLocalizedString("yes", comment: ""), for: .normal)
        overallPaddyNo_btn.setTitle(NSLocalizedString("no", comment: ""), for: .normal)
        
        PexalonUsedYes_btn.setTitle(NSLocalizedString("yes", comment: ""), for: .normal)
        PexalonUsedNos_btn.setTitle(NSLocalizedString("no", comment: ""), for: .normal)
    ...
    func changeHiddenStatusOfSeasons(isHidden : Bool){
        ...
        viewHeightConstraint.constant = updateProfileHeigthConstraint.constant + 550
        //
        //        updateProfileHeigthConstraint.constant = 707
    ...
    @objc func submitBtn_Touch_Up_Inside() {
        ...
        else if Validations.isNullString(enterCrop_textfielf.text! as NSString) {
            self.view.makeToast(howmanyAcres)
            return
        }
        ...
        if net?.isReachable == true{
            ...
            if isFromUpdate == true{
                ...
                self.recordScreenView("CEPProfileActivity", "CEPProfileUpdateViewController")
                ...
                let dic : NSDictionary = [
                    ...
                    "mdoMno" : txt_MDOno.text ?? "",
                    "mobileNumber" : txtMobileRvillage.text ?? "",
                    "optInWhatsApp" : false,
                    "pexalonKharifSeason" : isPExalonKharifused,
                    "pincode" : txtPincodeField.text ,
                    "retailerMno" : txt_retailerMobileNo.text ?? "",
                    "riceAcres" : enterCrop_textfielf.text ?? "",
                    "stateName" : stateTextfield.text ?? "",
                    "yieldPaddy" : yieldOfPaddy,
                    "imagePath" : strSubmitted,
                ]
                
                
                let paramsDic = NSMutableDictionary(dictionary: dic)
//                paramsDic.setValue("ffZ_S0YSeE3zuvsZg5yrB5:APA91bFCztfIVKSkQ6ISzbbfnqgCQNWQRIs8p7Pl636ArxLUHtr3EMHznd8WO5rt9hFfwyfEg3IUBLLEQ1gTtAgZuX2DDrEXPaXLMngSJcmmKCqr37cQc2AGpt7ZV-ep6BTYgmyR-5DM", forKey: "deviceToken")
    ...
    func uploadingWithMultiPartFormData( _ str : String, imgFileName : String){
      ...
      //  multipartFormData.append(strSubmitted.data(using: String.Encoding.utf8)!, withName: "imagePath")
            
            
            // multipartFormData.append((data), withName: "encodedData")
          ...
          //  DispatchQueue.main.async {
             ...
             //   }
                //            multipartFormData.append(paramsStr.data(using: String.Encoding.utf8)!, withName: "encodedData")
    ...
    func renderRegistrationScreen(){
        self.submitBtn.setTitle(NSLocalizedString("update", comment: "").uppercased(), for: .normal)
        self.lblTitle?.text = NSLocalizedString("Enrollement_ProfileUpdateCep", comment: "")
        ...
        downBtn.setImage(UIImage(named:"location-marker"), for:.normal)
...
//        submitBtn.backgroundColor = UIColor(red: 104.0/255.0, green: 104.0/255.0, blue: 104.0/255.0, alpha: 1)
    ...
    func assignDataToFields(){
        ...
        enterCrop_textfielf.text = userObj.riceAcres as String? ?? ""
        ...
        if userObj.yieldPaddy as String? ?? "" == "Yes"{
            yieldOfPaddy = "Yes"
            overallPaddyYes_btn.setImage(UIImage(named: "SelectRadioBlue"), for: .normal)
            overallPaddyNo_btn.setImage(UIImage(named: "Radio"), for: .normal)
        }
        
        if userObj.pexalonKharifSeason as String? ?? "" == "Yes"{
            isPExalonKharifused = "Yes"
            PexalonUsedYes_btn.setImage(UIImage(named: "SelectRadioBlue"), for: .normal)
            PexalonUsedNos_btn.setImage(UIImage(named: "Radio"), for: .normal)
        }
        txt_retailerMobileNo.text = userObj.retailerMno as String? ?? ""
        txt_MDOno.text = userObj.mdoMno as String? ?? ""
    ...
    func renderUpdateScreen(){
        ...
        if arrCrops.count > 6 {
            ...
            viewCropsHeightConstraint.constant = collectionViewCropsHeightConstraint.constant + 665
        ...
        let singleTapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(CEPProfileUpdateViewController.contentViewTapGestureRecognizer(_:)))
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.lblPaddyused.text = NSLocalizedString("cep_used_kharif", comment: "")
...
//                    submitBtn.backgroundColor = UIColor(red: 104.0/255.0, green: 104.0/255.0, blue: 104.0/255.0, alpha: 1)
        ...
        if textField == txt_retailerMobileNo {
...
//        let currentLanguage = Locale.current.languageCode//CSLanguage.currentAppleLanguage()
