...
class CEPLandingViewController: BaseViewController,UIScrollViewDelegate ,RewardsPopUpProtocol, UIPopoverPresentationControllerDelegate,UIPopoverControllerDelegate, AcvissionDelegate{
