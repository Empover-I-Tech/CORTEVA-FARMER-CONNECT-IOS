...
public struct TimelinePoint {
    ...
    public init(diameter: CGFloat, color: UIColor, filled: Bool) {
        self.init(diameter: diameter, lineWidth: 1.0, color: color, filled: filled)
    }
    
    public init(color: UIColor, filled: Bool) {
        self.init(diameter: 2.0, lineWidth: 1.0, color: color, filled: filled)
    }
    
    public init() {
        self.init(diameter: 2.0, lineWidth: 1.0, color: UIColor.lightGray, filled: false)
    }
