...
//****/
@property (copy, nonatomic, readonly) NSString *jwtPayloadStr;
...
//********/
@property (strong, nonatomic, readonly) JWTBuilder *(^payloadStr)(NSString *payloadStr);
...
@property (copy, nonatomic, readonly) NSString *encode1;
