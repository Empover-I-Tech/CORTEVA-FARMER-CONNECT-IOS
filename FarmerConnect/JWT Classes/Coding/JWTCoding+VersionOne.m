...
+ (NSDictionary *)decodeMessage:(NSString *)theMessage withSecret:(NSString *)theSecret withError:(NSError *__autoreleasing *)theError withForcedAlgorithmByName:(NSString *)theAlgorithmName skipVerification:(BOOL)skipVerification whitelist:(NSSet *)theWhitelist
{
    ...
    if (!skipVerification) {
        ...
        /*/Users/empoveri-techpvtltyd/Documents/MeetintroV3/untitled folder copy/ClassesJWT/Coding/JWTCoding+VersionOne.m:259:42: 'verifySignedInput:withSignature:verificationKey:' is deprecated: deprecated. will be removed in release version: 3.0*/
    }
