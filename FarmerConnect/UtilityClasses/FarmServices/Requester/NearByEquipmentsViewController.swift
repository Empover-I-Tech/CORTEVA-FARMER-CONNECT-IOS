//
//  NearByEquipmentsViewController.swift
//  FarmerConnect
//
...
class NearByEquipmentsViewController: RequesterBaseViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.recordScreenView("NearByEquipmentsViewController", FSR_Equipment_List)
