...
@objc class ClusterMarkerView: UIView {
    @objc @IBOutlet var imageEquipment : UIImageView?
    @objc @IBOutlet var imgCount : UIImageView?
    ...
    @objc class func instanceFromNib() -> ClusterMarkerView {
        return UINib(nibName: "ClusterMarkerView", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! ClusterMarkerView
    }
