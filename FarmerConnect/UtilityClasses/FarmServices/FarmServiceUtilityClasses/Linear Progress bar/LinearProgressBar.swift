...
open class LinearProgressBar: UIView {
    ...
    @IBInspectable public var barColor: UIColor = UIColor (red: 153.0/255, green: 153.0/255, blue: 153.0/255, alpha: 1.0)
    /// The color of the base layer of the bar
    @IBInspectable public var trackColor: UIColor = UIColor (red: 153.0/255, green: 153.0/255, blue: 153.0/255, alpha: 1.0)
    ...
    var maximumProgressValue : CGFloat = 0
    ...
    @IBInspectable public var progressValue: CGFloat = 0 {
        didSet {
            progressValue = progressValue.clamped(lowerBound: 0, upperBound: maximumProgressValue)
            setNeedsDisplay()
        }
    }
    @IBInspectable public var upperValue: CGFloat = 0 {
        didSet {
            maximumProgressValue = upperValue
            setNeedsDisplay()
        }
    }
    ...
    func calculatePercentage() -> CGFloat {
        ...
        let progress = ((progressValue / maximumProgressValue) * screenWidth)
