...
public extension UICollectionView {
    ...
    convenience init(frame: CGRect = .zero, centeredCollectionViewFlowLayout: CenteredCollectionViewFlowLayout) {
        ...
        decelerationRate = UIScrollViewDecelerationRate.init()
    }
}
...
open class CenteredCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override open func invalidateLayout(with context: UICollectionViewLayoutInvalidationContext) {
        ...
        if !currentCollectionViewSize.equalTo(lastCollectionViewSize) || lastScrollDirection != scrollDirection || lastItemSize != itemSize {
            ...
            case .horizontal:
                ...
                collectionView.contentInset = UIEdgeInsets(top: 0, left: 10, bottom: 0, right: inset)
    ...
    override open func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        switch scrollDirection {
        case .horizontal:
            //newOffset = candidateAttributesForRect.center.x+5 - (collectionView.bounds.size.width-20) / 2
            newOffset = candidateAttributesForRect.center.x+5 - (UIScreen.main.bounds.size.width-20) / 2
